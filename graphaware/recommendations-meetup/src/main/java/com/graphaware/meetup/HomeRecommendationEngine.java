...
public class HomeRecommendationEngine extends Neo4jTopLevelDelegatingRecommendationEngine{
    ...
    protected List<RecommendationEngine<Node, Node>> engines() {
        return Arrays.<RecommendationEngine<Node, Node>>asList(
                ...
                "MATCH (u:User)-[r:RATED]->(m:Movie)-[s:SIMILARITY]-(reco:Movie) WHERE id(u)={id} WITH 5*avg(r.rating*s.coeff) AS score, reco return score, reco order by score desc limit 100;"),
